...
using SleepyStructures;
using SleepyStructures.Patches;
using SleepyStructures.Patches.Pieces;
...
public class Plugin : BaseUnityPlugin
{
    ...
    void AddPatches()
    {
        ...
        _manager.RegisterPatch(new WearNTearPatches());
        _manager.RegisterPatch(new WearNTearUpdaterPatches());
